...
Gem::Specification.new do |s|
  ...
  "outputs, analog inputs, SPI, I2C, WS2812b, One Wire, and rough servo control via a friendly interface which responds " +
  "both to familiar Wiring/Arduino style methods and a more concise ruby alternative. LittleWire can be installed on to " +
  "Digispark devices, offering a very extensive firmata-style option for digispark users."
